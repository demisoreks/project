        ...
        <div id="accordion1">
            <div class="card">
                ...
                <div id="collapse3" class="collapse show" aria-labelledby="heading3" data-parent="#accordion1">
                    <div class="card-body">
                        <table id="myTable1" class="display-1 table table-condensed table-hover table-striped responsive">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th width="14%" data-priority="1">&nbsp;</th>
                                    <th width="12%" data-priority="1">&nbsp;</th>
                                    <th width="4%" data-priority="1">&nbsp;</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="card">
                ...
                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion1">
                    <div class="card-body">
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped responsive">
                            <thead>
                                <tr class="text-center">
                                    <th data-priority="1"><strong>NAME</strong></th>
                                    <th width="15%"><strong>VENDOR</strong></th>
