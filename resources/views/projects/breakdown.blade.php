    ...
    <div class="col-4">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="@if (App\Update::where('project_id', $project->id)->sum('amount_spent') > $project->budget) text-danger @endif">{{ number_format(App\Update::where('project_id', $project->id)->sum('amount_spent'), 2) }}</td>
            </tr>
        </table>
        <div class="card">
            <div class="card-body text-center">
                <h1 class="display-4">{{ $weighted_average }}%</h1>
            </div>
        </div>
    </div>
    <div class="col-8">
        ...
        <table id="myTable3" class="display-1 table table-condensed table-hover table-striped">
            <thead>
                <tr class="text-center">
                    ...
                    <th width="20%"><strong>AMOUNT SPENT</strong></th>
                    <th width="30%"><strong>REMARKS</strong></th>
                </tr>
            </thead>
            <tbody>
