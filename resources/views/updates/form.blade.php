<div class="form-group row">
    {!! Form::label('tracking_date', 'Tracking Date *', ['class' => 'col-md-3 col-form-label']) !!}
    <div class="col-md-4">
        {!! Form::date('tracking_date', $value = null, ['class' => 'form-control', 'placeholder' => 'Tracking Date', 'required' => true]) !!}
    </div>
</div>
<div class="form-group row">
    {!! Form::label('amount_spent', 'Amount Spent *', ['class' => 'col-md-3 col-form-label']) !!}
    <div class="col-md-4">
...
<div class="form-group row">
    {!! Form::label($component->id, $component->description.' *', ['class' => 'col-md-3 col-form-label']) !!}
    <div class="col-md-4">
...
<div class="form-group row">
    {!! Form::label('remarks', 'Remarks *', ['class' => 'col-md-3 col-form-label']) !!}
    <div class="col-md-4">
